    ...
    <form action="{{route('AddedProduct')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
                ...
                <div class="row container">
                    <div class="col-md-7" style="margin-top:10px;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="productName" name="productName" value="{{ old('productName') }}">
                            <span class="text-danger">@error('productName') {{ $message }} @enderror</span>
                            <span class="text-danger" id="productNameError"></span>
                        </div>
                        <div class="form-group">
                            <label for="">Description</label>
                            <textarea class="form-control input-square" rows="3" id="description" name="description" value="{{ old('description')}}"></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-square" id="buyingPrice" name="buyingPrice" value="{{ old('buyingPrice') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input-square" id="sellingPrice" name="sellingPrice" value="{{ old('sellingPrice') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control input-square" id="quantity" name="quantity" value="{{ old('quantity') }}">
                            <span class="text-danger">@error('productName') {{ $message }} @enderror</span>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-8" style="margin-top:8%">
                                <img id="myImg" src="assets/img/defaultP.jpg" alt="your image" style="height:300px; width:250px" class="thumb">
            ...
            <div class="card-action">
                <div class="row container">
                    <div class="col-md-6">
                    <button id="do" class="btn btn-block btn-success rounded-0">Add Product</button>
                    </div>
            </div>
            </form>
        </div>
